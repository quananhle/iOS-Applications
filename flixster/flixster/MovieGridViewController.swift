...
//        let interItemSpacingTotal = layout.minimumInteritemSpacing * (cellsPerLine - 1)
        let width = (view.frame.size.width - layout.minimumInteritemSpacing * (cellsPerLine - 1)) / cellsPerLine
                      layout.itemSize = CGSize(width: width, height: width * cellsPerLine/(cellsPerLine - 1))
